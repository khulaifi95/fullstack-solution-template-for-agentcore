...
SYSTEM_PROMPT = (
    ...
    "rankings, or relationships across those tables. Write a single read-only "
    "SQL SELECT in Athena/Presto syntax; the tool description lists the schema, "
    "join keys, and data-quality caveats (match text status columns "
    "case-insensitively).\n"
